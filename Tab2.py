...
class Character(QtWidgets.QGroupBox):
    def __init__(self):
        ...
        self.characterLayout.setContentsMargins(10, 10, 10, 10)
        ...
        self.deletePhoto_btn.setObjectName('deletePhoto_btn')
    ...
    def retranslateUi(self):
        ...
        self.delete_btn.setText(_translate("", "移除"))
...
class Tab2(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        spacerItem_V = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        self.verticalLayout_2.addItem(spacerItem_V)
        ...
        self.verticalLayout.addItem(spacerItem_V)
        ...
        self.rolesLayout.addWidget(Character())
        self.rolesLayout.addWidget(Character())
        self.rolesLayout.setContentsMargins(10,10,10,10)
        ...
        self.selectPhoto_btn.setObjectName("photo_btn")
        icon = qta.icon('fa5s.trash')
        self.deletePhoto_btn = QtWidgets.QPushButton()
        self.deletePhoto_btn.setIcon(icon)
        self.deletePhoto_btn.setObjectName('deletePhoto_btn')
